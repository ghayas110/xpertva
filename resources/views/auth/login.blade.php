...
<div class="w-full max-w-md bg-white rounded-lg shadow-md p-8">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-6">
            ...
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:ring focus:border-blue-500" 
