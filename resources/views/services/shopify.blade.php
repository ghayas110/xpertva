...
<div class="min-h-screen bg-[#0b0b0b] text-white">
    ...
    <section class="relative w-full pt-36 pb-20 bg-gradient-to-br from-[#0d0d0d] via-[#111] to-[#0c0c0c] overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <p class="text-gray-300 leading-relaxed max-w-2xl text-lg mb-8">
                Comprehensive shopify services solutions tailored to your business needs. 
    ...
    <section class="max-w-7xl mx-auto px-6 py-20">
        <div class="mb-12">
            ...
            <p class="text-gray-400 max-w-3xl">
                Our specialized team provides end-to-end support for all your Shopify Services needs.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @php
            $shopifyServices = [
                ['title' => 'Store Setup & Customization', 'desc' => 'Building a custom Shopify store tailored to your brand.'],
                ['title' => 'Product Upload & Management', 'desc' => 'Bulk uploading products and managing inventory levels.'],
                ['title' => 'Payment Gateway Integration', 'desc' => 'Setting up secure payment gateways for smooth transactions.'],
                ['title' => 'App Integration', 'desc' => 'Integrating essential apps for reviews, email marketing, and more.'],
                ['title' => 'Theme Customization', 'desc' => 'Customizing themes to match your brand identity and requirements.'],
                ['title' => 'SEO Optimization', 'desc' => 'Optimizing your store structure and content for search engines.'],
                ['title' => 'Marketing & Promotions', 'desc' => 'Setting up discount codes and marketing campaigns.'],
                ['title' => 'Customer Support', 'desc' => 'Handling customer queries via live chat or email.'],
                ['title' => 'Order Management', 'desc' => 'Streamlining the order processing and fulfillment workflow.']
            ];
            @endphp

            @foreach($shopifyServices as $service)
    ...
    <section class="py-24 text-center bg-gradient-to-b from-[#1a1a1a] to-[#0b0b0b] border-t border-[#222]">
        <h2 class="text-3xl md:text-4xl font-bold mb-4 text-white">
            Ready to Optimize Your Shopify Services?
        </h2>
