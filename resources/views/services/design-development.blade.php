...
<div class="min-h-screen bg-[#0b0b0b] text-white">
    ...
    <section class="relative w-full pt-36 pb-20 bg-gradient-to-br from-[#0d0d0d] via-[#111] to-[#0c0c0c] overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <p class="text-gray-300 leading-relaxed max-w-2xl text-lg mb-8">
                Comprehensive design & development solutions tailored to your business needs. 
    ...
    <section class="max-w-7xl mx-auto px-6 py-20">
        <div class="mb-12">
            ...
            <p class="text-gray-400 max-w-3xl">
                Our specialized team provides end-to-end support for all your Design & Development needs.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @php
            $designServices = [
                ['title' => 'Logo Design', 'desc' => 'Creating unique and memorable logos for your brand.'],
                ['title' => 'Brand Identity', 'desc' => 'Developing a cohesive visual identity across all platforms.'],
                ['title' => 'Packaging Design', 'desc' => 'Designing attractive packaging that stands out on shelves.'],
                ['title' => 'Print Design', 'desc' => 'Creating business cards, flyers, and brochures.'],
                ['title' => 'Social Media Graphics', 'desc' => 'Designing engaging posts and banners for social media.'],
                ['title' => 'Marketing Materials', 'desc' => 'Producing high-quality marketing assets for campaigns.'],
                ['title' => 'Infographics', 'desc' => 'Visualizing data and information in an easy-to-understand format.'],
                ['title' => 'Website Design', 'desc' => 'Designing user-friendly and visually appealing websites.'],
                ['title' => 'App Development', 'desc' => 'Building custom mobile applications for iOS and Android.'],
                ['title' => 'UI/UX Design', 'desc' => 'Designing intuitive user interfaces and experiences.']
            ];
            @endphp
    ...
    <section class="py-24 text-center bg-gradient-to-b from-[#1a1a1a] to-[#0b0b0b] border-t border-[#222]">
        <h2 class="text-3xl md:text-4xl font-bold mb-4 text-white">
            Ready to Optimize Your Design & Development?
        </h2>
