...
<div class="min-h-screen bg-[#0b0b0b] text-white">
    ...
    <section class="relative w-full pt-36 pb-20 bg-gradient-to-br from-[#0d0d0d] via-[#111] to-[#0c0c0c] overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <p class="text-gray-300 leading-relaxed max-w-2xl text-lg mb-8">
                Comprehensive ebay services solutions tailored to your business needs. 
    ...
    <section class="max-w-7xl mx-auto px-6 py-20">
        <div class="mb-12">
            ...
            <p class="text-gray-400 max-w-3xl">
                Our specialized team provides end-to-end support for all your eBay Services needs.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @php
            $ebayServices = [
                ['title' => 'Store Setup & Optimization', 'desc' => 'Setting up your eBay store for maximum visibility and sales.'],
                ['title' => 'Product Listing & Management', 'desc' => 'Creating and managing professional listings for your inventory.'],
                ['title' => 'Customer Service', 'desc' => 'Prompt and professional responses to buyer messages and inquiries.'],
                ['title' => 'Order Fulfillment', 'desc' => 'Efficient processing and tracking of orders to ensure timely delivery.'],
                ['title' => 'Marketing & Promotions', 'desc' => 'Running eBay promotions and markdown manager campaigns.'],
                ['title' => 'Account Health Management', 'desc' => 'Keeping your seller standards high to avoid restrictions.'],
                ['title' => 'eBay SEO Optimization', 'desc' => 'Optimizing listings with right keywords to rank higher in search.'],
                ['title' => 'Promotions & Advertising', 'desc' => 'Managing promoted listings to increase product visibility.'],
                ['title' => 'eBay Cases', 'desc' => 'Resolving disputes, returns, and cancellations effectively.']
            ];
            @endphp

            @foreach($ebayServices as $service)
    ...
    <section class="py-24 text-center bg-gradient-to-b from-[#1a1a1a] to-[#0b0b0b] border-t border-[#222]">
        <h2 class="text-3xl md:text-4xl font-bold mb-4 text-white">
            Ready to Optimize Your eBay Services?
        </h2>
